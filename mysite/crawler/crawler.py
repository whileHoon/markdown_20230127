...
class Crawler:
    def __init__(self):
        # 크롤링을 시작 할 페이지
        self.start_url = "https://www.iloom.com/product/item.do?categoryNo=523"
        self.visited_list = set()
        self.to_visit = set()
        # 상품과 연결될 카테고리
        self.category = ['거실', '액세서리']
        # csv 파일이 저장될 경로
        self.csv_path = "C:/Users/while/Desktop/cd_KDH/csv/"
        # 이미지 파일이 저장될 경로
        self.img_path = 'C:/Users/while/Desktop/cd_KDH/img/25/'
